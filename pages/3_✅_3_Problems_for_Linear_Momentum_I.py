...
# Music-Player
music = [
    'data\music\wings_of_freedom_-_epica_x_titan.mp3',
    'data\music\invincible_-_world_of_warcraft_ost.mp3',
    'data\music\a_song_played_by_the_stars_-_steinsgate_ost.mp3',
    'data\music\awe_of_she_-_guilty_gear_ost.mp3',
    'data\music\beyond_the_matrix_-_epica_acoustic_(beyond_the_good_the_bad_and_the_ugly).mp3',
    'data\music\beyond_the_matrix_-_epica.mp3',
    'data\music\crimson_bow_and_arrow_-_epica_x_titan.mp3',
    'data\music\davy_jones_-_unknow_source.mp3',
    'data\music\dedicate_your_heart_-_epica_x_titan.mp3',
    'data\music\endlessness_-_nightwish.mp3',
    'data\music\gate_of_steiner_-_steinsgate_ost.mp3',
    'data\music\majesty_-_ben_moon_ft_veela.mp3',
    'data\music\mayuri_sadness_-_steinsgate_ost.mp3',
